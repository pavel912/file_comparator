...
public class DiffBuilder {
    public static TreeMap<String, Map<String, Object>> buildDifference(Map<String, Object> content1,
        ...
        allKeysList.forEach(x -> keyDiff.put(x, buildKeyDiff(content1, content2, x)));

        return keyDiff;
    }

    private static Map<String, Object> buildKeyDiff(Map<String, Object> content1, Map<String, Object> content2,
                                                    String key) {
